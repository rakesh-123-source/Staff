...
PANEL_CHANNEL_ID = APPLICATIONS_CHANNEL_ID  # Or a dedicated channel for the panel
...
# UI View for application form button
class ApplicationView(discord.ui.View):
    def __init__(self):
        super().__init__(timeout=None)
        # Replace with the URL where your application form is hosted.
        self.add_item(discord.ui.Button(label="View Application", url="https://gamersdojo.netlify.app/appication.html", style=discord.ButtonStyle.url))
...
# -------------------------------
@bot.tree.command(name="start_panel", description="Creates a staff application panel.")
...
@bot.tree.command(name="end_applications", description="Ends the current staff applications.")
...
@bot.tree.command(name="pending_staffs", description="Lists all pending staff applications.")
...
@bot.tree.command(name="select_staff", description="Selects a staff application.")
...
@bot.tree.command(name="active_staffs", description="Lists all active (selected) staffs.")
